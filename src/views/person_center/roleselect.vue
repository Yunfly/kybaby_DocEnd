...
<div>
    ...
    <router-link id="role_item" v-bind:to="{path:'/service/doctor_certification', query:{type:'医生', status:'未申请'}}">
      <div id="role_item_div1">
        <div>我是医生</div>
      </div>
    </router-link>

    <router-link id="role_item" v-bind:to="{path:'/service/nurse_certification', query:{type:'护士', status:'未申请'}}">
      <div id="role_item_div2">
          <div>我是护士</div>
      </div>
    </router-link>

    <router-link id="role_item" v-bind:to="{path:'/service/technician_certification', query:{type:'技师', status:'未申请'}}">
