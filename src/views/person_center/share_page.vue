<template>
  <div class="bgf8">
    <div id="header" class="doctor_header">
      ...
      <div class="header_center font18">提交成功</div>
    </div>

    <div id="container">
      <div class="text-center">
        <br><br><br>
        <img class="currect" src="../../public/img/person_center/currect.png"/>
        <br>
        <span class="font14">提交成功，请耐心等待审核</span>
        <br><br><br><br>

        <div id="code"></div></div>
      <br><br><br>
      <div class="sharebtn text-center" v-on:click="showShare()">
        <button class="btn btn_block">分享给其他医生注册</button>
        <span>分享注册有奖励哦~</span>
      </div>
    </div>
    <div class="tc-content" v-show="share" v-on:click="showShare()">
      <img src="../../public/img/person_center/share02.png" height="212" width="500"/>
    </div>
  </div>
</template>
<script>
