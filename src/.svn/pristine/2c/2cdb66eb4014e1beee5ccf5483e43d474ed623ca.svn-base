...
export default new Router({
  ...
  routes: [
    ...
    {//分享by yb
      path: '/share_page',
      component:resolve =>{
      require(['../views/person_center/share_page'],resolve)
      }
    },
    {//忘记密码
      path: '/forget_password',
      component:resolve =>{
        require(['../views/common/forget_password'],resolve)
      }
    }
    ,
    {//改派申请
      path: '/door_apply_change',
      component:resolve =>{
        require(['../views/home/door_apply_change'],resolve)
      }
    }
  ]
});
