  ...
  <div>
    <div id="header" class="doctor_header">
      ...
      <div id="layer_menu" v-show="layer_menu" class="font12 hidden">
        ...
        <div>
          <router-link  :to="{path:'/contracted_user/contracted_user_all/health_record/basic_information', query:{id:this.userId}}" >
            健康档案
          </router-link>
        </div>
      </div>
            ...
            <div class="doctor_li" v-if="item.isReply =='N'">
              <div class="flex_cont flex_simple">
                <div class="header_img">
                  <img :src="imgUrl+consulting.userImg.split('::')[0]" v-if="hasPic" alt="" />
    ...
    <div v-if="isTag" class="isTag">
      <router-link :to="{path:'/consulting/consulting_illness_impression',query: {logId:this.logId,userId:this.userId,isTag:this.isTag}}" >
      <button class="btn btn_block font16 ">添加病情印象</button>
      </router-link>
    </div>
      ...
      <div id="other_content" class="padding control" v-show='other_content'>
        <div class="other_item">
          <ul class="flex_cont ">
            ...
            <li class="flex_item">
              <img src="../../public/img/consulting/menzhen.png" alt="" @click="quickRecovery">
              快捷回复
            </li>
          </ul>
        </div>
