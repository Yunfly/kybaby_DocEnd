  ...
  <div>
    ...
    <div id="footer_box" class="bgfff">
        <div class="footer_box flex_cont content_center">
            <p class="delete_btn" id="delete_btn" v-on:click="clearText()"></p>
    ...
    methods : {
      ...
      submit_comment : function (id) {
        ...
        if(text != "") {
          ...
          this.$ajax.post(ringHost+'doctorRringManage.action',"action=postReply&postInfoId="+id+"&postContent="+text)
            .then(function(result){
              if(result.data.mes=="操作成功") {
